...
const create = function create(options) {
  ...
  out.start = function() {
    out.getNextDoTime((err, getNextDoTimeRe) => {
      ...
      vlog.log('===> timeWork[%s] started. at:', options.name || 'default', cck.msToTime());
      out.lastDoTime = 0;
